...
contract MasterFarmer is Ownable, MinterRole  {
    ...
    string public constant name = "Master Farmer Token";
    string public constant symbol = "CROPS";
    ...
    function withdraw() external onlyMinter returns (bool) {
        ...
        //uint256 mtokensPerBlock = tokensPerBlock.mul(1000); //2.5%->25/1000
        //mtokensPerBlock = mtokensPerBlock.sub(mtokensPerBlock.mod(975));
        //mtokensPerBlock = mtokensPerBlock.div(975);
        
        MasterFarmer(tokencontractAddress).transfer(msg.sender, tokensPerBlock);
    ...
    function readyToMint() public view returns (bool) {
        ...
        uint256 limittime = lastMintedtime + 100;
